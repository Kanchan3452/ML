...
X["PropertyArea"] = le.fit_transform(X["PropertyArea"])

X["SelfEmployed"] = le.fit_transform(X["SelfEmployed"])
...
for i in range(len(y_pred)):
    ...
    if y_pred[i] == 1:
        result = "Loan Approved (Yes)"
    else:
        result = "Loan Not Approved (No)"
